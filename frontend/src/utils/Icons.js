export const dashboard = <i className="fa-solid fa-house" />;
...
export const lagout = <i className="fa-solid fa-sign-out" />;
...
export const calender = <i className="fa-solid fa-calender" />;
